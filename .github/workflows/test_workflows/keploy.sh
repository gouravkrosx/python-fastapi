...
sudo -E env PATH="$PATH" /usr/local/bin/keployE test -c "${GITHUB_WORKSPACE}/scripts/keploy_local_server.sh" --delay 20 --freezeTime --apiTimeout 300 --generateGithubActions=false
